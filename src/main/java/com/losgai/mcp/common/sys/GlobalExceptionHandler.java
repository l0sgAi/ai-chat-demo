package com.losgai.mcp.common.sys;// GlobalExceptionHandler.java

import com.losgai.mcp.enums.ErrorCode;
...
public class GlobalExceptionHandler {
    ...
    public Result<String> handleMediaTypeNotAcceptable(HttpMediaTypeNotAcceptableException ex) {
        log.error("[媒体类型不支持] {}", ex.getMessage());
        return Result.error("媒体类型不支持");
    }
